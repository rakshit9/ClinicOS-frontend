...
interface PremiumResetPasswordProps {
  onNavigate: (screen: AuthScreen) => void;
}
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="space-y-2">
            <TextField
              ...
              showPasswordToggle
            />
            <PremiumPasswordStrength password={formData.newPassword} className="px-4" />
          </div>
