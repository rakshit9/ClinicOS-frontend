      ...
      <div className="space-y-2">
        <div className="flex items-start gap-3">
          <div className="relative flex items-center justify-center">
            ...
            <div
              className={cn(
                "w-5 h-5 border-2 border-border rounded-lg transition-all duration-200 cursor-pointer",
                "touch-target-48 flex items-center justify-center bg-white",
                "shadow-[inset_0_1px_2px_rgba(0,0,0,0.06)]",
                "hover:border-primary",
                "focus-within:ring-2 focus-within:ring-primary-hover focus-within:ring-offset-2",
                checked && "bg-primary border-primary shadow-lg shadow-primary/25",
                error && "border-danger",
                className
              )}
            >
        ...
        {error && (
          <p className="text-sm text-danger ml-8 leading-none">{error}</p>
        )}
      </div>
    );
  }
